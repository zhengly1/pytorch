  ...
  } else
  {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND2(
        ...
        [&] {
          ...
          // Convert transpose characters to boolean
          bool transpose_a = (args.transa == 't' || args.transa == 'T' || args.transa == 'c' || args.transa == 'C');
          bool transpose_b = (args.transb == 't' || args.transb == 'T' || args.transb == 'c' || args.transb == 'C');
          
          // Launch CUTLASS GEMM with ULP perturbation
          at::native::cutlass_gemm::launch_cutlass_gemm_ulp_perturbation<scalar_t>(
              transpose_a,
              transpose_b,
              args.m,
              args.n,
